...
local create_titlebar = function(c, bg, size)
  ...
  Hover_signal(titlebar.main.margin.spacing.closebutton, color["Red200"], color["Base"])
  Hover_signal(titlebar.main.margin.spacing.maximizebutton, color["Yellow200"], color["Base"])
  Hover_signal(titlebar.main.margin.spacing.minimizebutton, color["Green200"], color["Base"])
end
