...
return function(s)
  ...
  local shutdown_button = button("Shutdown", icondir .. "shutdown.svg", color["Love"], shutdown_command)
  local reboot_button = button("Reboot", icondir .. "reboot.svg", color["Gold"], reboot_command)
  local suspend_button = button("Suspend", icondir .. "suspend.svg", color["Rose"], suspend_command)
  local logout_button = button("Logout", icondir .. "logout.svg", color["Foam"], logout_command)
  local lock_button = button("Lock", icondir .. "lock.svg", color["Iris"], lock_command)

  -- Signals to change color on hover
  Hover_signal(shutdown_button.background, color["Love"], color["Base"])
  Hover_signal(reboot_button.background, color["Gold"], color["Base"])
  Hover_signal(suspend_button.background, color["Rose"], color["Base"])
  Hover_signal(logout_button.background, color["Green200"], color["Base"])
  Hover_signal(lock_button.background, color["Foam"], color["Base"])
