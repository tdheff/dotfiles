  ...
  function(n)
    if n.urgency == "critical" then
      n.title = string.format("<span foreground='%s' font='JetBrainsMono Nerd Font, ExtraBold 16'>%s</span>",
        color["Love"], n.title) or ""
      n.message = string.format("<span foreground='%s'>%s</span>", color["Love"], n.message) or ""
      n.app_name = string.format("<span foreground='%s'>%s</span>", color["Love"], n.app_name) or ""
      n.bg = color["Overlay"]
    else
      n.title = string.format("<span foreground='%s' font='JetBrainsMono Nerd Font, ExtraBold 16'>%s</span>",
        color["Rose"], n.title) or ""
      n.message = string.format("<span foreground='%s'>%s</span>", color["Rose"], n.message) or ""
      n.bg = color["Overlay"]
                  ...
                  {
                    {
                      {
                        {
                          image = gears.color.recolor_image(icondir .. "notification-outline.svg", color["Pine"]),
                          resize = false,
                          widget = wibox.widget.imagebox
                        },
                        right = dpi(5),
    ...
    Hover_signal(close, color["Overlay"], color["Foam"])
