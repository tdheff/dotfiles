...
return function(s)
          ...
          {
            {
              ...
              resize = false,
              image = gears.color.recolor_image(icondir .. "keyboard.svg", color["Base"])
            },
            id = "icon_layout",
        ...
        awful.spawn.easy_async_with_shell(
          ...
          function(stdout)
            ...
            if kb_layout_item.keymap == layout then
              ...
              kb_layout_item:get_children_by_id("background2")[1].fg = color["Base"]
              kb_layout_item:get_children_by_id("background1")[1].fg = color["Base"]
            else
  ...
  -- Signals
  Hover_signal(kblayout_widget, color["Green200"], color["Base"])
