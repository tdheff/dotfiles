...
return function()
  ...
  awful.widget.watch(
    ...
    function(_, stdout)
      ...
      bluetooth_widget.icon_margin.icon_layout.icon:set_image(gears.color.recolor_image(icon .. ".svg", color["Text"]))
    end,
    bluetooth_widget
  )

  -- Signals
  Hover_signal(bluetooth_widget, color["Pine"], color["Text"])
