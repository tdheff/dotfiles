...
return function(widget)
          ...
          {
            {
              ...
              image = gears.color.recolor_image(icon_dir .. "gpu.svg", color["Base"]),
              resize = false
            },
            id = "icon_layout",
  ...
  Hover_signal(gpu_usage_widget, color["Green200"], color["Base"])
          ...
          {
            {
              id = "icon",
              widget = wibox.widget.imagebox,
              image = gears.color.recolor_image(icon_dir .. "cpu.svg", color["Base"]),
              resize = false
            },
            id = "icon_layout",
            widget = wibox.container.place
  ...
  watch(
    ...
    function(_, stdout)
      ...
      Hover_signal(gpu_temp_widget, temp_color, color["Base"])
